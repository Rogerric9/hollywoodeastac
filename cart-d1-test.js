...
const CHECKOUT_WORKER_URL =
  "https://hollywood-east-checkout-test.steve-kanski.workers.dev";
  ...
  paypal.Buttons({
    createOrder: async function() {
      ...
      const response = await fetch(
        `${CHECKOUT_WORKER_URL}/create-paypal-order`,
        {
          method: "POST",
          headers: {
    ...
    onApprove: async function(data) {
      ...
      const response = await fetch(
       `${CHECKOUT_WORKER_URL}/capture-paypal-order`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
    ...
    onCancel: async function(data) {
      ...
      try {
        const response = await fetch(
          `${CHECKOUT_WORKER_URL}/release-paypal-reservation`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
